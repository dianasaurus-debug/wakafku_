...
module.exports = (app) => {
    ...
    app.get('/api/wakaf-berjangka/:id', wakifValidator.verifyToken, wakifValidator.getWakifData, wakafBerjangkaController.getAllByUser);
    ...
    app.get('/api/admin/wakaf-berjangka/all/:id', adminValidator.verifyToken, wakafBerjangkaController.getAllByUser);
