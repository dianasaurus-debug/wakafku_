    ...
    <div class="col-12 mt-3">
      ...
      <div class="card">
        <div class="card-header border-0">
          <h3 class="card-title">Wakaf Berjangka</h3>
        </div>
          ...
          <div class="modal-body">
            <table class="table table-hover">
              ...
              <tr>
                ...
                <td>{{wakaf.nomor_rekening}}</td>
              </tr>
              <tr>
                <th scope="row">Bank Pengembalian</th>
                <td>{{wakaf.nama_bank}}</td>
              </tr>
              <tr>
                <th scope="row">A/N Pengembalian</th>
                <td>{{wakaf.nama_pemilik_rekening}}</td>
              </tr>
              <tr>
                <th scope="row">Kode Pembayaran</th>
                <td>
                  <img :src="wakaf.kode_pembayaran" v-if="wakaf.metode_pembayaran=='gopay'" height="150px">
                  <h5 v-else>{{wakaf.kode_pembayaran}}</h5></td>
              </tr>
              <tr>
...
export default {
  ...
  data() {
    return {
      columns: [
        ...
        {label: 'Kode Pembayaran', field: 'kode_pembayaran'},
  ...
  methods: {
    ...
    getAllWakafBerjangka() {
      axios.get(URL + '/api/wakaf-berjangka/' , {headers: authHeader(), data_wakif : this.currentUser.data}).then(function (response) {
