              ...
              <div class="card" style="max-width: 700px">
                <div class="card-horizontal">
                  ...
                  <div class="card-body">
                    ...
                    <!--                             :style="progressStyle(selectedProgram.terkumpul,selectedProgram.target)">Rp.-->
                    <!--                          {{ selectedProgram.terkumpul }}-->
                    <!--                        </div>-->
                    <!--                      </div>-->
                    <!--                      <h6 class="float-right">Dari Rp. <b>{{ selectedProgram.target | filterMoney }}</b></h6>-->
                    <!--                    </div>-->
                  </div>
                </div>
              </div>
