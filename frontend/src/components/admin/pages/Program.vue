        ...
        <div class="card-body table-responsive p-0">
          <vue-good-table
            ...
            <template slot="table-row" slot-scope="props">
              ...
              <!--                                     <span v-if="formatDate(props.row.createdAt)<=formatDate(props.row.deadline)" class="badge badge-pill badge-primary">Ongoing</span>-->
              <!--                                     <span v-if="formatDate(props.row.createdAt)>formatDate(props.row.deadline)" class="badge badge-pill badge-success">Selesai</span>-->
              <!--                                </span>-->
              <!--                                <span v-else-if="props.column.field == 'target'">-->
              <!--                                  {{props.row.target | filterMoney}}-->
              <!--                                </span>-->
              <span v-else>
